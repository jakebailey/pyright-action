...
var require_manifest = __commonJS({
  "node_modules/.pnpm/@actions+tool-cache@2.0.2/node_modules/@actions/tool-cache/lib/manifest.js"(exports2, module2) {
    ...
    function _getOsVersion() {
      ...
      let version2 = "";
      if (plat === "darwin") {
        version2 = cp3.execSync("sw_vers -productVersion").toString();
      } else if (plat === "linux") {
...
var require_tool_cache = __commonJS({
  "node_modules/.pnpm/@actions+tool-cache@2.0.2/node_modules/@actions/tool-cache/lib/tool-cache.js"(exports2) {
    ...
    function _createToolPath(tool, version2, arch) {
      return __awaiter(this, void 0, void 0, function* () {
        const folderPath = path3.join(_getCacheDirectory(), tool, semver.clean(version2) || version2, arch || "");
...
async function downloadPyright(info3) {
  const version2 = info3.version.format();
  const found = tc.find(pyrightToolName, version2);
  if (found) {
    return found;
  }
  const tarballPath = await tc.downloadTool(info3.tarball);
  const extractedPath = await tc.extractTar(tarballPath);
  return await tc.cacheDir(extractedPath, pyrightToolName, version2);
}
...
function checkOverriddenFlags(version2, args) {
  ...
  if (fs.existsSync(configPath)) {
    const errors = [];
    parsed = parse2(fs.readFileSync(configPath, "utf8"), errors, {
